---
title: Sass - 前端工程師應該要會的工程化 CSS - @mixin 與 @extend
keywords:
  - CSS, Sass, SCSS
categories:
  - CSS
...
Sass 的主要功能前方都會使用 `@` 符號表示，雖然 Sass 本身有縮寫的版本但只提供 Sass 使用 SCSS 是不吃的，這邊就統一用 SCSS 的方式來表示囉!喜歡 Sass 寫法的可以參考官網有說明各功能的縮寫方式。
