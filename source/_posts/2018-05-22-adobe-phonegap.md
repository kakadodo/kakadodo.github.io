...
這問題連想都不用想，已經有人把這概念實際做出來了 Σ(ﾟ д ﾟ)
...
3. [Adobe PhoneGap CLI](https://build.phonegap.com/)
   ...
   ![blog image](https://firebasestorage.googleapis.com/v0/b/for-hexo.appspot.com/o/2018-05-22-adobe-phonegap-5.jpg?alt=media&token=efaf2f3c-1292-405c-9082-2f8f6242ec5a 'Adobe account 選擇')
   要使用 PhoneGap Build 需要有 Adobe 的帳號，一般帳號有一個免費的私有 APP 空間，APP 的大小需在 50MB 內，如果要放更多 APP 空間的話，就要成為付費會員囉!
...
專案建立後，打開資料夾可以看到自動幫你生好的資料結構，主要會動到的只有 **www 資料夾** 跟 **config.xml** (plugin 資料夾是在有需要使用行動裝置硬體的 API 才會用到，不然也可以略過)，www 資料夾就是主要放置 HTML、CSS、JavaScript 及靜態資料的地方，其中 res 的資料夾存放 APP 會用到的 icon 圖示及 screen 畫面(screen 畫面需要搭配 Codorva API 設定才會出現)。

![blog image](https://firebasestorage.googleapis.com/v0/b/for-hexo.appspot.com/o/2018-05-22-adobe-phonegap-4.jpg?alt=media&token=4d15fb8f-1478-4559-b3ec-a4ac2cc43174 'PhoneGap 自動生成的 config.xml')
...
`<name>`則是該 APP 的顯示名稱，`<description>`是 APP 的描述，`<author>`應該不用說了吧 XD，這些會在上架到 Google 商店時看的到。
...
![blog image](https://firebasestorage.googleapis.com/v0/b/for-hexo.appspot.com/o/2018-05-22-adobe-phonegap-6.jpg?alt=media&token=30735c4f-2f97-4fcb-a8fe-7f4da5f4864b 'PhoneGap Build 操作步驟')
